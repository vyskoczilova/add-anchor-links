...
class AddAnchorLinksTest extends TestCase
{
	...
	public function testDuplicateHeadingsGetUniqueIds()
	{
		$added = AddAnchorLinks::add_anchors('<h2>Overview</h2><h2>Overview</h2><h2>Overview</h2>');
		...
		$this->assertStringContainsString('href="#overview"', $added);
